                    ...
                    <div class="menu-container js_nav-item">
                        ...
                        <div class="logo">
                            <a class="logo-wrap" href="#body">
                                ...
                                <p class="logo-img logo-img-main">and<span>zub</span></p>
                                <p class="logo-img logo-img-active">and<span>zub</span></p>
                            </a>
                        </div>
                        <!-- End Logo -->
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="promo-block-divider">
                            <h1 class="promo-block-title">Andrey <br/> Zub</h1>
                            <p class="promo-block-text">Back-end Developer</p>
                        </div>
